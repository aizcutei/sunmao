...
pub struct clap_plugin_t {
    ...
    pub activate: Option<unsafe extern "C" fn(plugin: *const clap_plugin_t, sample_rate: f64, min_frames_count: u32, max_frames_count: u32) -> bool>,
    ...
    pub process: Option<unsafe extern "C" fn(plugin: *const clap_plugin_t, process: *const clap_process_t) -> clap_process_status>,
    pub get_extension: Option<unsafe extern "C" fn(plugin: *const clap_plugin_t, id: *const c_char) -> *const c_void>,
