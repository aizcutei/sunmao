...
pub struct clap_plugin_posix_fd_support_t {
    pub on_fd: Option<unsafe extern "C" fn(plugin: *const clap_plugin_t, fd: i32, flags: clap_posix_fd_flags_t)>,
}

#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct clap_host_posix_fd_support_t {
    pub register_fd: Option<unsafe extern "C" fn(host: *const clap_host_t, fd: i32, flags: clap_posix_fd_flags_t) -> bool>,
    pub modify_fd: Option<unsafe extern "C" fn(host: *const clap_host_t, fd: i32, flags: clap_posix_fd_flags_t) -> bool>,
