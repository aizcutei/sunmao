...
pub struct clap_plugin_state_t {
    pub save: Option<unsafe extern "C" fn(plugin: *const clap_plugin_t, stream: *const clap_ostream_t) -> bool>,
    pub load: Option<unsafe extern "C" fn(plugin: *const clap_plugin_t, stream: *const clap_istream_t) -> bool>,
}
