...
pub struct clap_plugin_mini_curve_display_t {
    ...
    pub render: Option<unsafe extern "C" fn(plugin: *const clap_plugin_t, curves: *mut clap_mini_curve_display_curve_data_t, curves_size: u32) -> u32>,
    pub set_observed: Option<unsafe extern "C" fn(plugin: *const clap_plugin_t, is_observed: bool)>,
    pub get_axis_name: Option<unsafe extern "C" fn(plugin: *const clap_plugin_t, curve_index: u32, x_name: *mut c_char, y_name: *mut c_char, name_capacity: u32) -> bool>,
}
...
pub struct clap_host_mini_curve_display_t {
    pub get_hints: Option<unsafe extern "C" fn(host: *const clap_host_t, kind: u32, hints: *mut clap_mini_curve_display_curve_hints_t) -> bool>,
