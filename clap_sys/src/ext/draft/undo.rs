...
pub struct clap_plugin_undo_delta_t {
    pub get_delta_properties: Option<
        unsafe extern "C" fn(
            ...
            properties: *mut clap_undo_delta_properties_t,
        ),
    >,
    pub can_use_delta_format_version:
        Option<unsafe extern "C" fn(plugin: *const clap_plugin_t, format_version: clap_id) -> bool>,
    pub undo: Option<
        unsafe extern "C" fn(
            plugin: *const clap_plugin_t,
...
pub struct clap_plugin_undo_context_t {
    ...
    pub set_undo_name:
        Option<unsafe extern "C" fn(plugin: *const clap_plugin_t, name: *const c_char)>,
    pub set_redo_name:
        Option<unsafe extern "C" fn(plugin: *const clap_plugin_t, name: *const c_char)>,
}
...
pub struct clap_host_undo_t {
    ...
    pub set_wants_context_updates:
        Option<unsafe extern "C" fn(host: *const clap_host_t, is_subscribed: bool)>,
}
