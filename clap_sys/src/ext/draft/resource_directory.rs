...
pub struct clap_plugin_resource_directory_t {
    pub set_directory: Option<unsafe extern "C" fn(plugin: *const clap_plugin_t, path: *const c_char, is_shared: bool)>,
    ...
    pub get_file_path: Option<unsafe extern "C" fn(plugin: *const clap_plugin_t, index: u32, path: *mut c_char, path_size: u32) -> i32>,
}

#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct clap_host_resource_directory_t {
    pub request_directory: Option<unsafe extern "C" fn(host: *const clap_host_t, is_shared: bool) -> bool>,
