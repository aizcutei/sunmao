...
pub struct clap_plugin_state_converter_t {
    ...
    pub convert_state: Option<
        unsafe extern "C" fn(
            converter: *mut clap_plugin_state_converter_t,
            src: *const clap_istream_t,
...
pub struct clap_plugin_state_converter_factory_t {
    pub count:
        Option<unsafe extern "C" fn(factory: *const clap_plugin_state_converter_factory_t) -> u32>,
    pub get_descriptor: Option<
        unsafe extern "C" fn(
            factory: *const clap_plugin_state_converter_factory_t,
            index: u32,
    ...
    pub create: Option<
        ...
        ) -> *mut clap_plugin_state_converter_t,
    >,
}
