...
pub trait Plugin: Sized + 'static {
    ...
    /// accepted and [`Plugin::state_loaded`] reports its version; a newer one
    /// is refused because this build cannot know how to read it.
    ...
    /// [`Plugin::STATE_VERSION`] — an identical version needs no migration.
