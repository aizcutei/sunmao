...
// - shared location and Linux physical-keycode mappings
...
// Linux evdev physical positions, using the XKB offset of eight.
// Adapted from Mozilla NativeKeyToDOMCodeName.h, formerly in x11/keyboard.rs.
#[cfg(target_os = "linux")]
pub(crate) fn hardware_keycode_to_code(hw_keycode: u32) -> Code {
    match hw_keycode {
        0x0009 => Code::Escape,
        0x000A => Code::Digit1,
        0x000B => Code::Digit2,
