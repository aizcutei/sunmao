...
- M1 进行中：第 1、2 项均已验收。第 2 项（speaker layout 动态协商）hosted
  ...
  已在 semantics.md 记为单格式能力。第 7 项（无界 fuzz 脚手架）本地就绪待 hosted：`fuzz/` 已建且**排除出 workspace**，本地实跑 300 万例无崩溃。
